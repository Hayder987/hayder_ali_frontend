...
const NavBar = () => {
  ...
  return (
    <div className="py-3 relative px-4 md:px-6 flex justify-between items-center ">
      ...
      {/* toggle Menu */}
      <div className={`${menu?"hidden":"flex"} absolute z-10 top-20 w-[90%] bg-[#1f0600] rounded-lg p-6 lg:hidden`}>
        <nav>
          <ul onClick={()=>setMenu(!menu)} className=" flex flex-col gap-4 font-medium ">
            <NavLink to="/">
              <li>Home</li>
            </NavLink>
            <li>Project</li>
