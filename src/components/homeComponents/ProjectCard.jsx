...
const ProjectCard = ({ post }) => {
  return (
    <div className="bg-[#1f2125] group p-6 rounded-lg shadow-[0_4px_10px_rgba(33,31,32,0.8),_0_1px_16px_rgba(89,88,89,0.5)] hover:shadow-[0_4px_24px_rgba(255,1,79,0.8)] duration-300">
