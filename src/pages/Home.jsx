  ...
  return (
    <div>
      ...
      <div className="container mx-auto mb-20 md:mb-32  ">
        <p className="font-normal text-xl text-center mb-4 text-[#ff014f]">Let Me introduce My-self</p>
        <h1 className="text-4xl md:text-6xl mb-14 text-center font-bold">About Me</h1>
        <AboutMe></AboutMe>
      </div>
      <div className="container mx-auto mb-20 md:mb-32 ">
        <p className="font-normal text-xl text-center mb-4 text-[#ff014f]">Technical & Professional</p>
        <h1 className="text-4xl md:text-6xl mb-14 text-center font-bold">My Skills</h1>
        <MySkill></MySkill>
      </div>
      <div className="container mx-auto mb-20 md:mb-32 ">
        <p className="font-normal text-xl text-center mb-4 text-[#ff014f]">Recent Project</p>
      ...
      <div className="container mx-auto ">
        <p className="font-normal text-xl text-center mb-4 text-[#ff014f]">Contact</p>
