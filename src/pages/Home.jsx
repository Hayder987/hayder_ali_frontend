  ...
  return (
    <div>
      ...
      <div
        ...
        className="container mx-auto mb-20 md:mb-32  "
      >
        <p className="font-normal text-xl text-center mb-4 text-[#ff014f]">
          Let Me introduce My-self
        </p>
        <h1 className="text-4xl md:text-6xl mb-14 text-center font-bold">
          About Me
        </h1>
        <AboutMe></AboutMe>
      </div>
